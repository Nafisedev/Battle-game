...
while running:
    ...
    for player in players:
        ...
        if index == 0:
            ...
            print("You attack " + enemies[enemy].name.replace("  ", "") + " for", dmg, "Point of damage.")
            ...
            if spell.type == "white":
                ...
                print(bcolors.OKBLUE + "\n" + spell.name + " deals " + str(magic_dmg), "Point of damage to" + enemies[enemy].name + bcolors.ENDC)
    ...
    for enemy in enemies:
        ...
        if enemy_choice == 0:
            ...
            if spell.type == "white":
                ...
                print(bcolors.OKBLUE + "\n" + enemy.name.replace("  ", "") + spell.name + "'s " + "deals " + str(magic_dmg), "point of damage to " + players[target].name.replace("  ", "") + bcolors.ENDC)
